...
class Clerk_Content
{
    ...
    public function clerk_woocommerce_archive_description()
    {
        ...
        ?>
        <span class="clerk" data-template="@<?php echo $options['category_content']; ?>" data-category="<?php echo $category->term_id; ?>"></span>
        <?php
        endif;
    }
    ...
    public function clerk_woocommerce_after_cart_table()
    {
        ...
        ?>
        <span class="clerk" data-template="@<?php echo $options['cart_content']; ?>" data-products="<?php echo json_encode($products); ?>"></span>
        <?php
        endif;
    }
