...
class Clerk_Admin_Settings
{
     ...
     */
    public function load_jquery_ui(): void
    {
    ...
    {
        echo '<span><p>' . esc_textarea($this->version) . '</p></span>';
    }

    /**
     * Add wpml multi language info
     */
    public function add_wpml_info(): void
    {
        $wpml_info = clerk_wpml_get_active_scope();
        echo '<span><p>' . esc_attr($wpml_info['native_name']) . '<code>' . esc_attr($wpml_info['language_code']) . '</code></p></span>';
    }
